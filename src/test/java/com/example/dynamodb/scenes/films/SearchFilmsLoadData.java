...
@Slf4j
public class SearchFilmsLoadData implements LoadData {
  ...
  public void apply(DynamoDbEnhancedClient dynamoDbEnhancedClient) {
    ...
    Stream.of(
        ...
        FilmDocument.builder().id(UUID.fromString("9d003dae-b6dc-4b44-9fd1-879b4c5f332e")).originalTitle("Another test original").build(),
        FilmDocument.builder().id(UUID.fromString("9d003dae-b6dc-4b44-9fd1-879b4c5f333e")).originalTitle("Another original title").build(),
        FilmDocument.builder().id(UUID.fromString("9d003dae-b6dc-4b44-9fd1-879b4c5f333e")).originalTitle("Another originalÑ títle").build()
